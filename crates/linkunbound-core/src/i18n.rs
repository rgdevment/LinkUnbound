...
catalogue! {
    ...
    reach_more: "Más" | "More",
    remember_url: "Recordar esta URL" | "Remember this URL",
    remember_subdomain: "Recordar el subdominio" | "Remember the subdomain",
    remember_site: "Recordar todo el sitio" | "Remember the whole site",
    remember_from_app: "Recordar desde {}" | "Remember from {}",
    update_ready: "Versión {} lista" | "Version {} ready",
    update_how: "Se descarga, se instala y LinkUnbound se reinicia solo" | "It downloads, installs and LinkUnbound restarts on its own",
    update_store: "La instala Microsoft Store desde Ajustes" | "Microsoft Store installs it, from Settings",
    update_open_settings: "Desde Ajustes, que explica cómo" | "From Settings, which says how",
    update_take: "Actualizar" | "Update",
    update_open: "Abrir" | "Open",
    update_starting: "Preparando la actualización…" | "Getting the update ready…",
    update_getting: "Descargando la {}…" | "Downloading {}…",
    update_installing: "Instalando la {}…" | "Installing {}…",
    update_restart: "LinkUnbound se reinicia en un momento" | "LinkUnbound restarts in a moment",
    update_failed: "No se pudo actualizar" | "The update did not go through",
    update_again: "Reintentar" | "Try again",
    update_later: "Ahora no" | "Not now",
